...
import { Form, Input, InputGroup, Button, CheckBox, Item, Label, Text, View } from 'native-base'
...
export default function SignInForm() {
  ...
  const initialValues = { name: 'hung.nguyen@integrify.io', password: 'Test123456' }
